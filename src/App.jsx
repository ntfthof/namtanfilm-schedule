                            ...
                            <div className="flex-shrink-0">
                              {idx === 0 ? (
                                <div className="flex items-center justify-between md:block w-full md:w-auto">
                                  ...
                                  <div className="md:hidden flex flex-col items-end justify-center gap-1.5 ml-4 flex-1">
                                    <div className={`inline-flex items-start text-right gap-1.5 px-2.5 py-1.5 rounded-lg text-[10px] font-bold border ${cat.bg} ${cat.text} ${cat.border}`}>
                                      <span className={`w-1.5 h-1.5 rounded-full ${cat.dot} flex-shrink-0 mt-[3px]`}></span>
                                      <span>{cat.label}</span>
                                    </div>
                                    <div className={`inline-flex items-start text-right gap-1.5 px-2.5 py-1.5 rounded-lg text-[10px] font-bold border ${remark.bg} ${remark.text} ${remark.border}`}>
                            ...
                            <div className="flex-1 min-w-0">
                              <div className={`flex flex-col md:flex-row items-start justify-between gap-2 md:gap-6`}>
                                ...
                                <div className={`flex-shrink-0 w-full md:w-auto mt-3 md:mt-0 gap-1.5 ${idx === 0 ? 'hidden md:flex md:flex-col md:items-end' : 'flex flex-row flex-wrap justify-start md:flex-col md:items-end'}`}>
                                  <div className={`inline-flex items-start md:items-center text-left md:text-right gap-1.5 px-3 py-1.5 rounded-lg text-[10px] md:text-[11px] font-bold border ${cat.bg} ${cat.text} ${cat.border} transition-colors`}>
                                    <span className={`w-1.5 h-1.5 rounded-full ${cat.dot} flex-shrink-0 mt-1 md:mt-0`}></span>
                                    <span>{cat.label}</span>
                                  </div>
                                  <div className={`inline-flex items-start md:items-center text-left md:text-right gap-1.5 px-3 py-1.5 rounded-lg text-[10px] md:text-[11px] font-bold border ${remark.bg} ${remark.text} ${remark.border} transition-colors`}>
                                    <span className="opacity-70 flex-shrink-0">{remark.short}</span>
                                    <span>{remark.label}</span>
                                  </div>
                                </div>
